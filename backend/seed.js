...
const seedData = async () => {
  try {
    ...
    const restaurants = await Restaurant.create([
      {
        name: 'Pizza Paradise',
        owner: owners[0]._id, // pizzaparadise@gmail.com
      ...
      {
        name: 'Burger Bistro',
        owner: owners[1]._id, // burgerbistro@gmail.com
      ...
      },
      {
        ...
        owner: owners[2]._id, // sahyadri@gmail.com
      ...
      },
      {
        ...
        owner: owners[3]._id, // sherepunjab@gmail.com
      ...
      },
      {
        ...
        owner: owners[4]._id, // dakshin@gmail.com
      ...
      {
        name: 'Gujarati Rasoi',
        owner: owners[5]._id, // gujaratirasoi@gmail.com
        address: 'Baner, Pune',
      ...
      },
      {
        ...
        owner: owners[6]._id, // tandoori@gmail.com
      ...
      {
        name: 'KFC',
        owner: owners[7]._id, // kfc@gmail.com
        address: 'Camp, Pune',
      ...
      },
      {
        ...
        owner: owners[8]._id, // kshatriya@gmail.com
    ...
    console.log('Created Restaurants successfully.');

    // 3. Create Menu Items across all categories
    const menuItems = await MenuItem.create([
      // Pizza Paradise Menu (Pizza, Italian, Desserts, Ice Creams)
      {
      ...
      // Burger Bistro Menu (Burgers, American, Sandwiches, Beverages)
      {
      ...
      // Sahyadri Maratha Delights (Maharashtrian, Indian, Thalis, Beverages)
      {
      ...
      // Sher-E-Punjab Rasoi (Punjabi, North Indian, Thalis, Desserts)
      {
      ...
      // Dakshin Kitchen (South Indian, Thalis, Fast Food, Beverages)
      {
      ...
      // Gujarati Rasoi (Gujarati, Vegetarian, Thalis, Desserts)
      {
      ...
      // Tandoori Nights Menu (North Indian, Tandoori)
      {
      ...
      // Hotel Kshatriya Garden Menu (Maharashtrian, Saoji, Thalis)
      {
    ...
    console.log('Created Menu Items successfully.');
    ...
    // 5. Create Previous Orders for Customer
    await Order.create([
      {
        customer: customer._id,
        restaurant: pizzaRest._id,
        items: [
          ...
          {
            menuItem: menuItems[4]._id, // Chocolate Lava Cake
      ...
      },
      {
        ...
        items: [
          {
            menuItem: menuItems[menuItems.length - 6]._id, // Chicken Zinger Burger
            name: menuItems[menuItems.length - 6].name,
            qty: 1,
            price: menuItems[menuItems.length - 6].price
          },
          {
            menuItem: menuItems[menuItems.length - 2]._id, // Fries (Medium)
    ...
    console.log('Created Previous Orders successfully.');
